...
class News_model extends CI_Model {
     ...
     */
    public function ajouter_news($auteur, $titre, $contenu, $image) {
     ...
     *  @return bool        Le résultat de la requête
     */
    public function editer_news($id, $titre = null, $contenu = null, $image) {
     ...
     public function editer_news2($id, $titre = null, $contenu = null) {
     ...
     */
    public function liste_news($nb =10, $debut ) {
